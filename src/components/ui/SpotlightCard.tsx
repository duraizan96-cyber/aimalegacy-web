  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: isHovered
            ? `radial-gradient(350px circle at ${mousePos.x}px ${mousePos.y}px, rgba(83, 58, 253, 0.08), transparent 60%)`
            : 'none',
        }}
      />
      ...
      <div
        ...
        style={{
          background: isHovered
            ? `radial-gradient(400px circle at ${mousePos.x}px ${mousePos.y}px, rgba(83, 58, 253, 0.15), transparent 60%)`
            : 'none',
