...
const footerLinks = [
  {
    title: 'Servicios',
    links: [
      { label: 'Diagnóstico Estratégico IA', href: '#servicios' },
      { label: 'Automatización de procesos', href: '#servicios' },
      { label: 'Agentes conversacionales', href: '#servicios' },
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              aria-label="Aima Legacy en Instagram"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="text-white/20 hover:text-accent transition-colors duration-200"
              aria-label="Izan Dura en LinkedIn"
            >
              <svg className="h-[18px] w-[18px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
