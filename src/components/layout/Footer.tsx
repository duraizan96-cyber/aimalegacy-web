...
const footerLinks = [
  ...
  // Legal: pendiente de crear páginas reales (/privacidad, /terminos, /cookies).
  // Obligatorio antes de activar Meta Pixel y captar tráfico EU (GDPR).
]
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
          ...
          <ScrollReveal className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              <img
                ...
                loading="lazy"
                decoding="async"
                className="h-10 w-10 rounded-xl object-cover shadow-[0_0_16px_rgba(212,175,55,0.2)]"
              />
              <div>
            ...
            <p className="text-sm text-white/35 leading-relaxed max-w-xs mb-5">
              Tu negocio funcionando mejor, gastando menos y facturando más.
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            {/* LinkedIn — pendiente de crear Company Page */}
          </div>
        </div>
      </div>
    </footer>
