    ...
    <section id="contacto" className="relative py-24 lg:py-32">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px]">
          <div className="morphing-blob w-full h-full bg-gradient-to-br from-gold/[0.06] via-gold/[0.02] to-blue/[0.03] blur-[100px]" />
        </div>
      </div>
        ...
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative glass-strong rounded-3xl p-10 lg:p-16 text-center">
              ...
              <div className="absolute top-10 right-10 w-24 h-24 bg-gold/[0.06] rounded-full blur-[40px] float" />
              ...
              <motion.div
                ...
                className="relative mx-auto mb-8 inline-flex items-center justify-center rounded-2xl bg-gold/10 p-4 pulse-ring"
              >
              ...
              <p className="mt-6 text-lg text-white/45 max-w-xl mx-auto leading-relaxed">
                Empieza con un diagnostico profesional. Analizamos tu negocio,
